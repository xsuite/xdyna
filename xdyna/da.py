...
#         return tmp_border_min,tmp_border_max
    ...
    def calculate_davsturns(self,from_turn=1e3,to_turn=None,nsteps=None):
        ...
        if self._lower_davsturns is None or self._upper_davsturns is None: # or to_turn not in self._lower_border:
                ...
                for at_turn in reversed(lturns):
                    ...
                    if not check_boundary_cross.empty and self.da_type in ['monte_carlo', 'free']:
                        ...
                        for rc in reversed(recheck):
                            ...
                            raw_border_min=lower_davsturns.loc[rc,'border'][0] #[rc][0]
                            raw_border_max=upper_davsturns.loc[rc,'border'][0] #[rc][0]
...
#                                 self._lower_davsturns_max[rc][0]=max(new_border_min.amplitude)
                    ...
                    upper_davsturns.loc[at_turn,'max'   ]=max(border_max.amplitude)
...
#                         self._upper_davsturns_max[at_turn]=[ max(border_max.amplitude) ]
    ...
    def plot_da_border(self,ax, at_turn=None, seed=None, type_plot="polar", 
        ...
        fit_max=polar_interpolation(upper_da.loc[at_turn,'border'][0].angle, 
...
# Not allowed on parallel process
def _da_smoothing(data,raw_border_min,raw_border_max,at_turn,DA_lim_min=None,
                  removed=pd.DataFrame(columns=['id']), active_warmup=True):
